<aside id="sidebar" class="w-64 h-screen flex-shrink-0 bg-white border-r border-slate-200 flex flex-col overflow-hidden z-50" style="transition: width 0.3s cubic-bezier(0.4,0,0.2,1);">
  ...
  <div class="flex items-center gap-3 px-5 py-5 border-b border-slate-200">
    ...
    <div class="sidebar-logo-text transition-all duration-300">
      <div class="font-display font-800 text-slate-900 text-base leading-tight">SiAbsen</div>
      <div class="text-slate-500 text-xs">v2.0 Digital</div>
    </div>
  </div>

  <!-- Nav -->
  <nav class="flex-1 overflow-y-auto px-3 py-4">
    <div class="sidebar-section-title text-xs font-display font-600 text-slate-400 uppercase tracking-widest mb-2 px-2 transition-all duration-300">Menu Utama</div>
    ...
    <div class="sidebar-section-title text-xs font-display font-600 text-slate-400 uppercase tracking-widest mb-2 px-2 mt-5 transition-all duration-300">Laporan</div>
